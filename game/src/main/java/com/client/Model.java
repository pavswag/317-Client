...
//            System.out.println("frame null");
    ...
    static boolean hasAnEdgeToRestrict[] = new boolean[25_000];
    static boolean outOfReach[] = new boolean[25_000];
    static int vertexScreenX[] = new int[25_000];
    static int vertexScreenY[] = new int[25_000];
    static int vertexScreenZ[] = new int[25_000];
    static int vertexMovedX[] = new int[25_000];
    static int vertexMovedY[] = new int[25_000];
    static int vertexMovedZ[] = new int[25_000];
