...
public class PetPerk extends RSInterface {
    ...
    public static void mainInterface(TextDrawingArea[] tda) {
        ...
        addText(48854, "The Vote Genie Pet is a beloved pet on Turmoil, obtaining with a rare chance upon claiming a vote or purchased from the vote store.", tda, 2, 0xff9933, true);
    ...
    private enum PetDescriptions {
        VOTE_PET(327, "The Vote Genie Pet is a beloved pet on Turmoil, obtaining with a rare chance upon claiming a vote or purchased from the vote store."),
